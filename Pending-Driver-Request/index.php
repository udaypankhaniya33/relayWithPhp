    ...
    <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <span class="text-muted font-weight-bold mr-4"> Pending Driver Requests</span>
...
<script language="javascript">
    var url = "../serverresponse/pendingRequests2.php";
    ...
    function rework(CustomerId) {
        ...
        const {
            ...
            if (text.value != "") {
                ...
                $.ajax({
                    url: "../ajax/reuploadReqDriver.php",
                    method: "POST",
                    data: {
                        value: text.value,
                        CustomerId: CustomerId
                ...
                if (confirm("Please Enter The Rework Information")) {
                    rework(CustomerId) 
                }else{
